...
const Contact = () => {
    ...
    return (
        <div className='bg-gray-200'>
            <div className="relative mx-auto pt-36 pb-40 px-4 w-full max-w-7xl text-gray-700">
                    ...
                    <div className="mt-10 mx-auto w-full max-w-xl">
                        <form action="" className="grid grid-cols-2 gap-y-6 gap-x-4" onSubmit={handleSubmit}>
                            ...
                            <div className="col-span-full pt-5">
                                <button type="submit" className="py-1.5 px-6 w-full sm:w-40 shadow-xl rounded bg-gradient-to-br from-lime to-slate-500 text-lg text-white hover:to-gray-600">SEND</button>
                            </div>
                        </form>
                    </div>
