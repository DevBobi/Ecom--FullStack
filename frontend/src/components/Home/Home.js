...
const Home = () => {
    return (
        <div className="relative w-full h-full flex justify-center bg-gradient-to-t from-black via-transparent to-gray-900 overflow-hidden">
            ...
            {/* :HERO IMAGE */}
            <img src="https://images.unsplash.com/photo-1522204523234-8729aa6e3d5f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="" className="backdrop-blur-sm absolute w-full h-full object-cover object-left sm:object-center opacity-70 " />
            ...
            <div className="relative py-28 xl:py-40 w-full md:w-2/3 lg:w-1/2 h-full flex flex-col justify-center">
                ...
                <div className="mx-5 md:mx-0 p-8 rounded-xl md:rounded-r-none bg-gray-800 bg-opacity-50 text-white shadow-2xl">
                    <h1 className="text-3xl sm:text-5xl font-josefin font-extrabold">Ecommerce, <br /><span className="text-yellow-400 text-opacity-80">Fancy Hero 8</span> est <br />Formidable !</h1>
                ...
                <button className="relative m-5 w-full md:w-2/3 lg:w-2/5 inline-flex items-center text-2xl font-firacode text-white overflow-hidden transition-all duration-300 transform hover:translate-x-4">
                    <Link to="/" className="relative -top-0.5 mr-2 text-gray-900 ">Explore</Link>
